...
const LUNAR_OB = [
    ...
    ['Grass Value','Curr/Grass',10,1.1,0.003,1],
    ['XP','Icons/XP',10,1.1,0.003,1],
    [`TP`,'Icons/TP',10,1.1,0.003,1],
    [`Cosmic`,'Icons/XP2',20,5,25,0],
    [`Charge`,'Curr/Charge',100,1.1,0.003,1],
    [`Rocket Fuel`,'Curr/RocketFuel',1000,100,0.1,0],
    [`Planetarium`,'Curr/Planetoid',20,5,25,0],
]
